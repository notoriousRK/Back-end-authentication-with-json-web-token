...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13_angular2_flash_messages__["FlashMessagesService"], __WEBPACK_IMPORTED_MODULE_14__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]],
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success && data.user.role == "Participant") {
                ...
                _this.flashMessage.show("You are now logged in as Participant", { cssClass: 'alert-success', timeout: 2000 });
                _this.router.navigate(['/']);
            }
            else if (data.success && data.user.role == "Organiser") {
                _this.authService.storeUserData(data.token, data.user);
                _this.flashMessage.show("You are now logged in in as Organiser", { cssClass: 'alert-success', timeout: 2000 });
...
module.exports = "<br>\n<h5 class=\"page-header\">Register</h5>\n<form (submit)=\"onRegisterSubmit()\">\n  <div class=\"form-group\">\n    <label >Name</label>\n    <input type=\"text\" name=\"name\" [(ngModel)]= \"name\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n      <label >Username</label>\n      <input type=\"text\" name=\"username\" [(ngModel)]= \"username\" class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n        <label >Email</label>\n        <input type=\"text\" name=\"email\" [(ngModel)]= \"email\" class=\"form-control\">\n      </div>\n  <div class=\"form-group\">\n      <label >Password</label>\n      <input type=\"password\" name=\"password\" [(ngModel)]= \"password\" class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n      <label >Role</label>\n      <br>\n      <input type=\"hidden\" name=\"role\" [(ngModel)]= \"role\" class=\"form-control\">\n      <br>\n      <input (click)= \"role ='Participant'\" type=\"button\" value =\"Participant\" class=\"btn btn-default\"> <input  (click)= \"role ='Organiser'\" type=\"button\" value=\"Organiser\" class=\"btn btn-default\">\n    </div>\n    <input type=\"submit\" value=\"Submit\" class=\"btn btn-warning\">\n  \n</form>\n"
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success && user.role == "Participant") {
                _this.flashMessage.show('You are now registered and can log in as Participant', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else if (data.success && user.role == "Organiser") {
                _this.flashMessage.show('You are now registered and can log in as Organiser', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
